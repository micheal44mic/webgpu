...
// categorizzazione, cioe' tutto cio' che puo' sbagliare senza una GPU.
{
  ...
  assert.deepEqual(
    GPU_MEMORY_CATEGORY_ORDER.slice(0, 7),
    [
      "Layer RGBA16F",
