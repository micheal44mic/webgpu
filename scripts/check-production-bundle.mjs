...
const forbiddenContentMarkers = [
  ...
  "gpu-diagnostics-application-4096-startup-v20",
  "shape-array-r16f-4layer-v1",
  "shape-array-r16float-2048x2048-4layer-full-mips-impulse-readback-no-tier2-v1",
  "application-4096-startup-v1",
  "application-startup-rgba16float-4096x4096-no-tier2-v1",
  "application-4096-pipelines-async2-v1",
