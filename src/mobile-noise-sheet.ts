...
export class MobileNoiseSheetController {
  readonly sheet = requiredElement<HTMLElement>("mobileNoiseSheet");
  readonly handle = requiredElement<HTMLButtonElement>("mobileNoiseHandle");
  readonly header = requiredElement<HTMLElement>("mobileNoiseHeader");
