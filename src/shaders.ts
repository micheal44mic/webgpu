...
// The promoted presentation path above remains untouched. This second module
// is selected only while the adaptive half-resolution preview is visible.
// It combines a transparent preview layer with the exact document before
// applying the same checkerboard and manual linear-to-sRGB conversion.
export const adaptivePreviewDisplayShader = /* wgsl */ `
struct DisplayUniforms {
  canvasSize: vec2<f32>,
  layerSize: vec2<f32>,
  viewCenter: vec2<f32>,
